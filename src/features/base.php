...
if ( !class_exists( 'ICWP_Maid_FeatureHandler_Base', false ) ):

	abstract class ICWP_Maid_FeatureHandler_Base extends ICWP_Maid_Foundation {
		...
		/**
		 * @var ICWP_Maid_FeatureHandler_Email
		 */
		protected static $oEmailHandler;

		/**
		 * @var ICWP_Maid_Processor_Base
		 */
		...
		protected function doExecutePreProcessor() {
			...
			return ( is_object( $oProcessor ) && $oProcessor instanceof ICWP_Maid_Processor_Base );
		}
		 ...
		 * @return ICWP_Maid_Processor_Base
		 */
		...
		/**
		 * @return ICWP_Maid_FeatureHandler_Email
		 */
		...
		/**
		 * @return ICWP_Maid_Processor_Email
		 */
