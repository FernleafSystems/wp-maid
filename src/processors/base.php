...
if ( !class_exists( 'ICWP_Maid_Processor_Base', false ) ):

	abstract class ICWP_Maid_Processor_Base extends ICWP_Maid_Foundation {

		/**
		 * @var ICWP_Maid_FeatureHandler_Base
		 */
		protected $oFeatureOptions;

		/**
		 * @param ICWP_Maid_FeatureHandler_Base $oFeatureOptions
		 */
		...
		/**
		 * @return ICWP_Maid_FeatureHandler_Base
		 */
